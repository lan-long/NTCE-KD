...
class BaseTrainer(object):
    ...
    def train_iter(self, data, epoch, train_meters):
        ...
        # preds, losses_dict, target_class_dict = self.distiller(image=image, target=target, epoch=epoch)
        ...
        # print info
        msg = "Epoch:{}| Time(data):{:.3f}| Time(train):{:.5f}| Loss:{:.4f}| Top-1:{:.3f}| Top-5:{:.3f}".format(
            epoch,
...
class AugTrainer(BaseTrainer):
    def train_iter(self, data, epoch, train_meters):
        ...
        # forward
        preds, losses_dict = self.distiller(image=image_weak, image_strong=image_strong, target=target, epoch=epoch)
